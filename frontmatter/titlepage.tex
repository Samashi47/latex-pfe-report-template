\begin{titlepage}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[height=2.5cm,width=6cm]{example-image-a} % Logo of the university
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[height=2.5cm,width=6cm]{example-image-b} % Logo of the institution
    \end{minipage}
    ...
    \vspace{0.2cm}
    \includegraphics[height=2.5cm,width=6cm]{example-image-c} % Logo of the company
